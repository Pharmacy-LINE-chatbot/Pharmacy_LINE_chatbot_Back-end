...
import com.example.phamacy_linechatbot_backend.util.CloudStorageHelper;
...
public class BucketController {
    ...
    public ResponseEntity<?> uploadFile(@RequestPart(value = "file")
        ...
        return
                ResponseEntity.ok(this.cloudStorageHelper.getImageUrl(file,"image-uploader-e2ddb.appspot.com"));
    }
}
